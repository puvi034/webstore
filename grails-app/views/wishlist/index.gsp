		...
		<div id="list-wishlist" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="wishlist.customer.label" default="Customer" /></th>
				...
				<g:each in="${wishlistInstanceList}" status="i" var="wishlistInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${wishlistInstance.id}">${fieldValue(bean: wishlistInstance, field: "customer")}</g:link></td>
